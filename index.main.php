<?php
/**
 * This is the main/default page template for the "premiumseries" skin.
 *
...
<div id="wrapper" >
	...
	<div id="page-bgbtm">
		...
		<div id="sidebar">
			...
			<?php
				if( $Skin->get_setting('display_b2evo_logo') )
				{
	...
	<div id="footer">
		<p>	
			...
			?>
			Design by <a title="Free CSS Templates" rel="nofollow" href="http://www.freecsstemplates.org/">Free CSS Templates</a> &bull; Converted by <a href="http://www.fromsmallacorns.com" title="Small Business Websites">Small Business Websites</a> &bull; Powered by <a href="http://www.b2evolution.net" title="b2evolution">b2evolution</a>
		</p>
	</div>
	<!-- end #footer -->
<?php
